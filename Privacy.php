		...
		<div class="content message-box-4 bt box-padding">
			<div class="row">
				<div class="small-12 columns">
					...
					<p>
					This Privacy Policy governs the manner in which MobioPush collects, uses, maintains and discloses information collected from users (each, a "User") of the mobiopush.com website ("Site"). This privacy policy applies to the Site and all products and services offered by MobioPush.
					...
					<p>MobioPush may collect and use Users personal information for the following purposes:</p>
					<ol>
					...
					kerala<br/>
					India<br/>
					support@mobiopush.com<br/>

					This document was last updated on November  26, 2014
					</p>
					</div>
			</div>
		</div>
